...
if __name__ == "__main__":
    input_fold = Path(r"D:\code\HBMErrors\submit_fold\Fig12_prediction")
    ...
    row_res_file = res_fold.joinpath(f"row-level_predictor.csv")
    col_res_file = res_fold.joinpath(f"col-level_predictor.csv")
    bank_res_file = res_fold.joinpath(f"bank-level_predictor.csv")
    server_res_file = res_fold.joinpath(f"server-level_predictor.csv")
